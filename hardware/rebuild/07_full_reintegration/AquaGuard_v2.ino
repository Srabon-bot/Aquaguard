// ============================================================================
// AquaGuard rebuild -- Step 7 of 7: full reintegration (v2)
// ============================================================================
// This is the first REAL merge of all the individually-tested rebuild steps
// back into one always-running sketch -- built from
// hardware/original_reference/AquaGuard_full_original.ino (the pre-teardown
// "end goal" reference), with two fixes applied and one new feature added:
//
// FIXED vs. the original reference sketch:
...
//
// NEW in this sketch -- Firebase-driven pH calibration (no more re-flashing
// ph_calibration_tool.ino over USB just to recalibrate):
...
//   pH calibration page on any phone/browser on the same network. Fixed to
//   vinegar (pH 2.4) / baking soda (pH 8.3) -- the user's stated standard
//   reference solutions -- see CAL_PH_ACID/CAL_PH_BASE below. Saves to the
//   SAME NVS namespace/keys ("phcal": v_acid/v_base/ph_acid/ph_base) that
//   01_ph_sensor.ino and ph_calibration_tool.ino already use, so this stays
//   fully compatible with those -- a calibration saved by any of the three
//   is readable by all three.
//
...
// firmware.
//
// SETUP: fill in your own WIFI_SSID/WIFI_PASSWORD/FIREBASE_HOST/FIREBASE_AUTH
// below -- see hardware/FIREBASE_SETUP.md. Never commit real values here.
// Same wiring as hardware/Hardware_Wiring_Guide.pdf / every rebuild/0N_*/
// step: TRIG=5, ECHO=18 (through the voltage divider), TDS=35, THERM=32,
// PH=34, PUMP1=25, PUMP2=26, SERVO=13.
// ============================================================================
